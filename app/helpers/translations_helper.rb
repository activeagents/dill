module TranslationsHelper
  TRANSLATIONS = {
    report_author: { "🇺🇸": "Author", "🇪🇸": "Autor", "🇫🇷": "Auteur", "🇮🇳": "लेखक", "🇩🇪": "Autor", "🇧🇷": "Autor" },
    report_subtitle: { "🇺🇸": "Subtitle", "🇪🇸": "Subtítulo", "🇫🇷": "Sous-titre", "🇮🇳": "उपशीर्षक", "🇩🇪": "Untertitel", "🇧🇷": "Subtítulo" },
    report_title: { "🇺🇸": "Report title", "🇪🇸": "Título del informe", "🇫🇷": "Titre du rapport", "🇮🇳": "रिपोर्ट का शीर्षक", "🇩🇪": "Berichtstitel", "🇧🇷": "Título do relatório" },
